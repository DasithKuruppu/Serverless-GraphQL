...
function queryEvents(event, context, callback) {
  Object(graphql__WEBPACK_IMPORTED_MODULE_1__["graphql"])(_schemas_index__WEBPACK_IMPORTED_MODULE_0__["default"], event.body).then(function (result) {
...
var dynamoDb = new aws_sdk__WEBPACK_IMPORTED_MODULE_0__["DynamoDB"].DocumentClient();
...
/* harmony default export */ __webpack_exports__["default"] = (function (data) {
  var putParams = createParams(data, process.env.TABLE_NAME, uuid_v4__WEBPACK_IMPORTED_MODULE_1__());
  return dynamoDb.put(putParams).promise().then(function () {
...
/* harmony default export */ __webpack_exports__["default"] = (function (id) {
  ...
  return dynamoDb.get(params).promise().then(function (GetEvents) {
...
/* harmony import */ var _resolvers_events_create__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../resolvers/events/create */ "./resolvers/events/create.ts");
/* harmony import */ var _resolvers_events_view__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../resolvers/events/view */ "./resolvers/events/view.ts");
/* harmony import */ var _resolvers_events_list__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../resolvers/events/list */ "./resolvers/events/list.ts");
/* harmony import */ var _resolvers_events_remove__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../resolvers/events/remove */ "./resolvers/events/remove.ts");
/*import {
  paginationToParams,
  dataToConnection
...
var eventType = new graphql__WEBPACK_IMPORTED_MODULE_0__["GraphQLObjectType"]({
  name: "Event",
  fields: {
    id: {
  ...
  query: new graphql__WEBPACK_IMPORTED_MODULE_0__["GraphQLObjectType"]({
    ...
    fields: {
      listEvents: {
        ...
        /*parent, args*/
        {
          return Object(_resolvers_events_list__WEBPACK_IMPORTED_MODULE_3__["default"])();
        }
      },
      viewEvent: {
        args: {
        ...
        /*parent,*/
        args) {
          return Object(_resolvers_events_view__WEBPACK_IMPORTED_MODULE_2__["default"])(args.id);
        }
      }
    }
  }),
  mutation: new graphql__WEBPACK_IMPORTED_MODULE_0__["GraphQLObjectType"]({
    ...
    fields: {
      createEvent: {
        ...
        /*parent, */
        args) {
          return Object(_resolvers_events_create__WEBPACK_IMPORTED_MODULE_1__["default"])(args);
        }
      },
      removeProduct: {
        args: {
        ...
        /*parent,*/
        args) {
          return Object(_resolvers_events_remove__WEBPACK_IMPORTED_MODULE_4__["default"])(args.id);
        }
      }
    }
  })
