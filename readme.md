## CI/CD wont work on github as this is ported from gitlab CI/CD I'm too lazy to change it but however an issue is available hope to change it in future, so please go to [Gitlab Repo](https://gitlab.com/DasithKuruppu/serverlessgraphql) or use gitlab if you want working CI/CD out of the box
