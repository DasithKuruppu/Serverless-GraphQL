CI/CD wont work on github as this uses gitlab CI/CD too lazy to change to travis CI to make it work on github so go to [Gitlab Repo](https://gitlab.com/DasithKuruppu/serverlessgraphql).
