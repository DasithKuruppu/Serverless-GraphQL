## CI/CD wont work on github as this uses gitlab CI/CD I'm too lazy to change to travis CI just to make it work on github, so please go to [Gitlab Repo](https://gitlab.com/DasithKuruppu/serverlessgraphql).
